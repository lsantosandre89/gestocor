    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input required type="text" id="descricao" name="descricao" value="{{ $ocorrencia->descricao }}" class="form-control" placeholder="Descreva a ocorrência">
            </div>

            <div class="form-group">
                <label for="data">Data da Ocorrência</label>
                <input required type="datetime-local" id="data" name="data" value="{{ $ocorrencia->data }}" class="form-control" placeholder="Ex.: AAAA-MM-DD HH:MM:SS">
            </div>
            ...
            <div class="form-group">
                <div class="col-auto my-1">
                    ...
                    <select required class="custom-select mr-sm-2" id="alunos_id" name="alunos_id">
                        <option selected value="{{ $ocorrencia->alunos_id }}">Manter Atual</option>
            ...
            <div class="form-group">
                <div class="col-auto my-1">
                    ...
                    <select required class="custom-select mr-sm-2" id="materias_id" name="materias_id">
                        <option selected value="{{ $ocorrencia->materias_id }}">Manter Atual</option>
            ...
            <div class="form-group">
                <div class="col-auto my-1">
                    ...
                    <select required class="custom-select mr-sm-2" id="tipos_id" name="tipos_id">
                        <option selected value="{{ $ocorrencia->tipos_id }}">Manter Atual</option>
